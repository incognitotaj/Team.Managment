...
namespace Team.API.Controllers
{
    ...
    public class ProjectClientsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<ProjectDto>>> Get(string projectId, string projectClientId)
        {
        ...
        public async Task<ActionResult<IEnumerable<ProjectDto>>> Create(string projectId, [FromBody] CreateProjectClientRequest request)
        {
        ...
        [ProducesResponseType((int)HttpStatusCode.NotFound)]
        public async Task<ActionResult<IEnumerable<ProjectDto>>> Update(string projectId, [FromBody] UpdateProjectClientRequest request)
        {
        ...
        [ProducesResponseType((int)HttpStatusCode.NoContent)]
        [ProducesResponseType((int)HttpStatusCode.NotFound)]
        public async Task<ActionResult<IEnumerable<ProjectDto>>> Delete(string projectId, string projectClientId)
        {
